...
export const StatusModal = ({competition, isOpen, onClose}) => {
    ...
    return(
        <Modal competition={competition} isOpen={isOpen} onRequestClose={onClose} className="items-center font-poppins flex flex-col min-w-[80%] sm:min-w-[600px] bg-white mx-auto shadow-xl relative overflow-y-auto scrollbar-thin rounded-[10px]" overlayClassName="flex justify-center items-center inset-0 fixed z-1000 bg-[rgba(0,0,0,0.5)] overflow-hidden">
            ...
            <div className="sm:grid grid-cols-[auto_1fr] gap-x-[30px] gap-y-[1.5em] sm:pl-[2em] pt-[2em] pb-[3em]">
