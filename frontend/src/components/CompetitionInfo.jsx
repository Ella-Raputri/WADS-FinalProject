...
export const CompetitionInfo = ({competition, isFirst}) => {
    ...
    return(
    <>
    <div className={`w-[90%] justify-self-center flex flex-col gap-14 items-center md:flex-row lg:w-[80%] ${isFirst ? "mt-[8em]" : "md:mt-[4em] mt-[5em]"} xl:max-w-[1200px] 2xl:max-w-[1800px]`}>    
