...
export const CompetitionInfo = ({competition, isFirst}) => {
    ...
    <div className={`w-[90%] justify-self-center flex flex-col gap-14 items-center md:flex-row lg:w-[80%] ${isFirst ? "mt-[8em]" : "md:mt-[4em] mt-[5em]"}`}>    
        ...
        <div className="w-[90%] flex flex-col justify-center md:w-[72%]">
            <p className="font-semibold text-[1.2rem] xl:text-[1.6rem] font-kanit">{competition.title}</p>
            <div className="text-[0.9rem] xl:text-[1.3rem] mt-1 text-[#818181] font-poppins">Category: {competition.category}</div>
            <div className="text-[0.9rem] xl:text-[1.3rem] mt-1 text-[#000000] font-poppins">{competition.description}</div>
            <div className="text-[0.9rem] xl:text-[1.3rem] mt-1 text-[#818181] font-poppins">Date: {competition.date}</div>
