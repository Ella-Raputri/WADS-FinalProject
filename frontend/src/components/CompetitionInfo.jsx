export const CompetitionInfo = ({competition, isFirst}) => {
    return(
    <div className={`w-[90%] justify-self-center min-h-[50vh] h-auto flex flex-col gap-14 ${isFirst ? "mt-[7em]" : "mt-[4em]"} items-center md:flex-row lg:w-[80%] ${isFirst ? "md:mt-[4em]" : "md:mt-[2em]"}`}>    
            ...
            <p className="font-semibold text-[1.2rem] font-kanit">{competition.title}</p>
                ...
                <button className="w-25 h-9 mt-3 color-component-red rounded-md hover:!bg-red-700 text-white">Register</button>
            </div>
        </div>
    );
}
