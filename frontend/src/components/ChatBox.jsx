...
export default function ChatBox({ msg, index, user, page }) {
  ...
  const isUserMessage = (page==='adminticketdetails' && user.role==='admin' && msg.AdminId===user.id) || (page==='ticketdetails' && msg.SenderId._id === user.id) || (page==='chatbot' && msg.Role==='user');    
