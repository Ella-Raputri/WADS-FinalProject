...
export function BarChartMulti() {
  return (
    <div className="flex flex-col items-center w-full lg:mt-15 lg:row-span-2 h-[300px] lg:h-[570px]">
      {/* Responsive Container for Dynamic Width */}
      <ResponsiveContainer width="90%" height='90%'>
        <BarChart data={chartData} barCategoryGap={20}>
          ...
          <Bar dataKey="received" fill="#DD3833" radius={4} name="Received" />
          <Bar dataKey="resolved" fill="#F9E04B" radius={4} name="Resolved" />
        </BarChart>
      </ResponsiveContainer>
    </div>
  );
